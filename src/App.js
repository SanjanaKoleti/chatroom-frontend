    ...
    <div style={{ textAlign: "center", marginTop: "50px" }}>
      ...
      >
        {messages.map((msg, index) => (
          <p key={index} style={{ color: "white" }}>{msg}</p>
        ))}
      </div>

      {/* 🔹 Wrapped Emoji, Input, and Send Button inside a single flex container }
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", marginTop: "10px" }}>
        ...
        {/* Send button /}
        <button onClick={sendMessage} style={{ padding: "10px", fontSize: "16px" }}>Send</button>
      </div>
